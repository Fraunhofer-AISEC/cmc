...
func TestVerify(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Success Verify Self-Signed JSON",
			args: args{
				data:     jwsDataSelfSigned,
				verifier: VerifyWithSelfSignedCert,
				s:        JsonSerializer{},
			},
			want: true,
		},
		...
		{
			name: "Fail Verify Invalid Self-Signed JSON",
			args: args{
				data:     jwsDataSelfSignedInvalid,
				verifier: VerifyWithSelfSignedCert,
				s:        JsonSerializer{},
			},
			want: false,
		...
		{
			name: "Success Verify Self-Signed CBOR",
			args: args{
				data:     coseDataSelfSigned,
				verifier: VerifyWithSelfSignedCert,
				s:        CborSerializer{},
			},
			want: true,
		...
		{
			name: "Fail Verify Invalid Self-Signed CBOR",
			args: args{
				data:     coseDataSelfSignedInvalid,
				verifier: VerifyWithSelfSignedCert,
				s:        CborSerializer{},
			},
			want: false,
...
var (
	...
	jwsDataSelfSigned = []byte(`{"payload":"eyJ2ZXJzaW9uIjoiIiwidHlwZSI6IkF0dGVzdGF0aW9uIFJlcG9ydCJ9","protected":"","signature":"xuWq3zwwYHYG8C33FwGtege6NqwMsezw8n3KqGFnzk0bo-Kg539WLwAEjjk5ADx7Did2wCh5juhvzhXBcIY1AQ"}`)
	...
	jwsDataSelfSignedInvalid = []byte(`{"payload":"eyJ2ZXJzaW9uIjoiIiwidHlwZSI6IkF0dGVzdGF0aW9uIFJlcG9ydCJ9","protected":"","signature":"NWjgOq0c-bmasgC_tTy8NVUKI25CGZ1j4P0_qlXnxWgxBLpno6J9cZSv7u_sFut6BAMwSBpyjHrgwSQBAsMy0Q"}`)
	...
	coseDataSelfSigned = dec("")
	...
	coseDataSelfSignedInvalid = dec("")
