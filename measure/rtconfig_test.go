...
func TestGetConfigMeasurement(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want:    dec("af4a972ece9a72b8f84e56305bae2737f6a91df127ad4e0be78b9e28c8487a94"),
			wantErr: false,
		},
	}
