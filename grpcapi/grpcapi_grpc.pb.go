...
func (UnimplementedCMCServiceServer) TLSCreate(context.Context, *TLSCreateRequest) (*TLSCreateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TLSCreate not implemented")
}
func (UnimplementedCMCServiceServer) TLSSign(context.Context, *TLSSignRequest) (*TLSSignResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TLSSign not implemented")
}
func (UnimplementedCMCServiceServer) TLSCert(context.Context, *TLSCertRequest) (*TLSCertResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TLSCert not implemented")
}
func (UnimplementedCMCServiceServer) PeerCache(context.Context, *PeerCacheRequest) (*PeerCacheResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method PeerCache not implemented")
}
...
func (UnimplementedCMCServiceServer) UpdateCerts(context.Context, *UpdateCertsRequest) (*UpdateCertsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateCerts not implemented")
}
...
func RegisterCMCServiceServer(s grpc.ServiceRegistrar, srv CMCServiceServer) {
	// If the following call panics, it indicates UnimplementedCMCServiceServer was
