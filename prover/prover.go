...
// claims are prover-asserted key/value pairs placed into the report context and therefore covered
// by the hardware evidence; nil if the caller asserts nothing.
